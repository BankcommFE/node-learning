...
;(function(){
	...
	// Popover template
	var tpl = [
		'<div class="popover1 clockpicker-popover">',
//			'<div class="arrow"></div>',
			'<div class="popover-title">',
				...
				' : ',
				'<span class="clockpicker-span-sec">00</span>',
			'</div>',
	...
	function ClockPicker(element, options) {
		var popover = $(tpl),
			...
			secView=popover.find('.clockpicker-span-sec'),
		...
		this.spanSec=popover.find('.clockpicker-span-sec');
...
//		this.spanSec.click($.proxy(this.toggleView, this, 'minutes'));
		this.spanSec.click(function(){
